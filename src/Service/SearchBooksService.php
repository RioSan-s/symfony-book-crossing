...
final class SearchBooksService
{
    ...
    private function searchCriteriaToArray(SearchBooksCriteria $searchCriteria): array
    {
        $criteriaForRepository = [
            ...
            'ph_id'=>$searchCriteria->getPhId(),
            'ph_nameOfPublicationHouse' => $searchCriteria->getPhNameOfPublicationHouse(),
            'ph_yearOfCreation' => $searchCriteria->getPhYearOfCreation(),
            'ph_ownerOfPublicationHouse' => $searchCriteria->getPhOwnerOfPublicationHouse(),
